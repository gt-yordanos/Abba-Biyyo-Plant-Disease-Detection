  ...
  return (
    <>
      ...
      <div className="text-center max-w-3xl mx-auto px-4 sm:px-8 md:px-12 lg:px-24 mt-6">
        ...
        >
          <span className="font-semibold text-green-400">Abbaa Biyyo</span> is
          an agricultural assistant app for Ethiopian farmers, offering disease
          detection, medicine suggestions, Q&A, weather updates, and a chatbot —
          all in local languages. This module is part of our initiative that detects a disease for the plant <i>corn</i>
          .
        </p>
      </div>
        ...
        >
          ...
          {preview && (
            <img
              src={preview}
              alt="Preview"
              className="mx-auto mb-4 max-h-64 rounded-xl"
            />
          )}
      ...
      <div className="flex justify-center mt-12 px-4 sm:px-8 md:px-12 lg:px-24">
        <div className="mockup-phone">
          ...
          <div
            className={`mockup-phone-display ${
              dark ? "bg-gray-800 text-white" : "bg-white text-gray-900"
            }`}
          >
            <div className="flex flex-col justify-center items-center h-full">
              ...
              <div
                className={`flex justify-around items-center py-4 w-full border-t ${
                  dark
